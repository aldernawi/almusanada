                    ...
                    <div class="main-card overflow-hidden hover:shadow-xl transition-all duration-300 card-lift group">
                        ...
                        <div class="p-5">
                            ...
                            <div class="flex gap-2 pt-4 border-t border-slate-100">
                                ...
                                <a href="{{ route('reviewer.forms.submissions', ['form' => $form]) }}" class="flex-1 bg-emerald-50 text-emerald-600 py-2.5 rounded-lg text-sm font-bold hover:bg-emerald-600 hover:text-white transition text-center">
