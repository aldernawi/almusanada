<div class="form-item-row main-card card-lift relative group flex flex-col h-full" data-title="{{ $form->title }}">
    ...
    <div class="p-4 flex-1 flex flex-col">
        ...
        <div class="flex items-center gap-1.5">
            ...
            @else
                ...
                <a href="{{ route('reviewer.forms.submissions', ['form' => $form]) }}" class="flex-1 bg-emerald-50 text-emerald-600 hover:bg-emerald-600 hover:text-white py-2 rounded-lg text-[11px] font-bold transition flex items-center justify-center gap-1">
                    <i class="fas fa-database"></i> Responses
                </a>
                <a href="{{ route('reviewer.forms.submissions', ['form' => $form]) }}" class="flex-1 bg-amber-50 text-amber-600 hover:bg-amber-600 hover:text-white py-2 rounded-lg text-[11px] font-bold transition flex items-center justify-center gap-1">
