...
@section('page_title', 'تعديل لائحة')
...
@section('content')
    <div class="container mx-auto px-4 py-8 max-w-3xl">
        ...
        <div class="main-card p-8">
            <h1 class="text-2xl font-extrabold text-slate-800 mb-6 pb-4 border-b border-slate-100 flex items-center gap-3"><i class="fas fa-edit text-amber-600"></i> تعديل اللائحة</h1>
