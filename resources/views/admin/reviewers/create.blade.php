...
@section('page_title', 'إنشاء مراجع جديد')
    ...
    <div class="container mx-auto px-4 py-8 max-w-2xl">
        <div class="mb-6">
            <a href="{{ route('admin.reviewers.index') }}"
                ...
                العودة إلى قائمة المراجعين
            </a>
        </div>

        <div class="bg-white rounded-lg shadow-md p-8">
            <h1 class="text-2xl font-bold text-gray-800 mb-6 pb-4 border-b">إنشاء حساب مراجع جديد</h1>

            <form action="{{ route('admin.reviewers.store') }}" method="POST">
                @csrf
                <div class="space-y-6">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">اسم المراجع <span
                    ...
                    <div>
                        ...
                        <p class="text-gray-400 text-xs mt-1">ملاحظة: كلمة المرور ظاهرة هنا لتتمكن من إعطائها للمراجع</p>
                    </div>
