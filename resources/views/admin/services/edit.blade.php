...
@section('content')
    <div class="max-w-3xl mx-auto">
        <div class="mb-8">
            ...
            <h1 class="text-2xl font-extrabold text-slate-800 mb-6 pb-4 border-b border-slate-100 flex items-center gap-3"><i class="fas fa-edit text-blue-600"></i> Edit Service</h1>
            <p class="text-slate-500 mt-1 font-medium">Editing service: {{ $service->title }}</p>
        </div>
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="title" value="{{ old('title', $service->title) }}" 
                               ...
                               placeholder="Example: Professional website design" required>
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="4" 
                                  ...
                                  placeholder="Write a brief and clear description of the service..." required>{{ old('description', $service->description) }}</textarea>
