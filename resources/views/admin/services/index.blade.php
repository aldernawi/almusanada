...
@section('content')
    <div class="max-w-6xl mx-auto">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            <div>
                <h1 class="text-2xl font-extrabold text-slate-800">Manage Services</h1>
                <p class="text-slate-500 mt-1 font-medium">Services displayed on the homepage</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            @empty
                <div class="col-span-full bg-slate-50 border-2 border-dashed border-slate-200 rounded-3xl p-12 text-center">
                    ...
                    <h3 class="text-lg font-bold text-slate-800">No services available</h3>
                    <p class="text-slate-500 max-w-xs mx-auto mt-2">Start by adding your first service to display on your website's homepage.</p>
                </div>
            @endforelse
        </div>
    </div>
